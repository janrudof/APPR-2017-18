...
Podatke sem uvozil is strani Statističnega urada republike Slovenije in strani World Tourism Organization v obliki CSV, XLSX in HTML. Podatki so v petih tabelah v obliki *tidy data*.
